...
class DnDCharacterProfileSheet extends Component<
...
> {
  ...
  render() {
    ...
    return (
      <div className='w-full d-and-d-character-sheet container-xl mx-auto mt-5 mb-5'>
        <div>
            ...
            <div className='col-md-3 pr-2 pl-2'>
              ...
              <div className='d-and-d-attribute-collection char-name pr-3 pl-3'>
                <input
                  ...
                  onChange={(e) => this.updateCharacter('name',  (e.target as HTMLInputElement).value)}
                />
              </div>
              <label
                style={{
                ...
                <div className='row pl-3 pr-3'>
                  <div className='col-md-4 col-6 pl-0 pr-0'>
                    <input
                      ...
                      onChange={(e) =>
                        this.updateCharacter('age',  (e.target as HTMLInputElement).value)
                      }
                    />
                    <label>Age</label>
                  </div>
                  <div className='col-md-4 col-6 pl-0 pr-0'>
                    <input
                      ...
                      onChange={(e) =>
                        this.updateCharacter('height',  (e.target as HTMLInputElement).value)
                      }
                    />
                    <label>Height</label>
                  </div>
                  <div className='col-md-4 col-6 pl-0 pr-0'>
                    <input
                      ...
                      onChange={(e) =>
                        this.updateCharacter('weight',  (e.target as HTMLInputElement).value)
                      }
                    />
                    <label>Weight</label>
                  </div>
                ...
                <div className='row pl-3 pr-3'>
                  <div className='col-md-4 col-6 pl-0 pr-0'>
                    <input
                      ...
                      onChange={(e) =>
                        this.updateCharacter('eyes',  (e.target as HTMLInputElement).value)
                      }
                    />
                    <label>Eyes</label>
                  </div>
                  <div className='col-md-4 col-6 pl-0 pr-0'>
                    <input
                      ...
                      onChange={(e) =>
                        this.updateCharacter('skin',  (e.target as HTMLInputElement).value)
                      }
                    />
                    <label>Skin</label>
                  </div>
                  <div className='col-md-4 col-6 pl-0 pr-0'>
                    <input
                      ...
                      onChange={(e) =>
                        this.updateCharacter('hair',  (e.target as HTMLInputElement).value)
                      }
                    />
                    <label>Hair</label>
                  </div>
            ...
            <div className='col-md-4'>
              ...
              <div className='d-and-d-box mt-3'>
                <textarea
                  ...
                  onChange={(e) =>
                    this.updateCharacter('backstory',  (e.target as HTMLInputElement).value)
                  }
                  rows={26}
                />
                <label className='d-and-d-title' style={{ marginTop: '10px' }}>
                ...
                <div className='row'>
                  <div className='col-md-6 border-right'>
                    <div className='d-and-d-gray-text' style={{ paddingBottom: '1px' }}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          this.updateCharacter('factionRank',  (e.target as HTMLInputElement).value)
                        }
                      />
                    </div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        this.updateCharacter('allies',  (e.target as HTMLInputElement).value)
                      }
                      rows={16}
                    />
                  </div>
                  <div className='col-md-6'>
                    <div className='d-and-d-box gray noborder' style={{marginBottom: '13px'}}>
                      <div className='d-and-d-faction-input'>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            this.updateCharacter('faction',  (e.target as HTMLInputElement).value)
                          }
                        />
                      </div>
                      <Image 
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        this.updateCharacter('allies2',  (e.target as HTMLInputElement).value)
                      }
                      rows={3}
                    />
                  </div>
                ...
                <div className='row'>
                  <div className='col-md-6 border-right'>
                    <textarea
                      ...
                      onChange={(e) =>
                        this.updateCharacter('additionalFeatures',  (e.target as HTMLInputElement).value)
                      }
                      rows={13}
                    />
                  </div>
                  <div className='col-md-6'>
                    <textarea
                      ...
                      onChange={(e) =>
                        this.updateCharacter('additionalFeatures2',  (e.target as HTMLInputElement).value)
                      }
                      rows={13}
                    />
                  </div>
                ...
                <div className='row'>
                  <div className='col-md-6 border-right'>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        this.updateCharacter('treasure',  (e.target as HTMLInputElement).value)
                      }
                      rows={8}
                    />
                  </div>
                  <div className='col-md-6'>
                    <textarea
                      ...
                      onChange={(e) =>
                        this.updateCharacter('treasure2',  (e.target as HTMLInputElement).value)
                      }
                      rows={10}
                    />
                  </div>
